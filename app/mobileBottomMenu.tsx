...
const mobileNavs: { [key: string]: ComponentType<{}> } = {
    ...
    three: dynamic(() => import("./mobileNavs/three/mobileNavThree"), { ssr: false }),
    four: dynamic(() => import("./mobileNavs/four/mobileNavFour"), { ssr: false }),
    five: dynamic(() => import("./mobileNavs/five/mobileNavFive"), { ssr: false }),
};
