  ...
  return(
   <div>
    ...
    <div className="container px-6 py-12  mx-auto">
        <div>
            <p className="font-medium text-blue-500 text-3xl dark:text-blue-400">𝙲𝚘𝚗𝚝𝚊𝚌𝚝 𝚞𝚜</p>
            ...
            <button aria-label="Log in with YouTube" className="p-3 rounded-sm">
                <FaYoutube className="w-5 h-5 fill-current" />
            </button>
            <button aria-label="Log in with Instagram" className="p-3 rounded-sm">
                <FaInstagram className="w-5 h-5 fill-current" />
            </button>
            <button aria-label="Log in with LinkedIn" className="p-3 rounded-sm">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
            <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">info@ebitans.com <br />
                    assist@ebitans.com</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">4th Floor, House: 39, Road: 20,
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-gray-500 ">Sat-Thus from 9am to 6pm.</p>
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+88 01886 515579<br />
                    +88 01886 515578</p>
                </div>
            </div>
